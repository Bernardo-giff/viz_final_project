...
We cannott really get good insights from the boxplots as they are because
...
We cannott really see a lot of difference between the distributions of the
...
types. Therefore, we will take the top 10 properties, which accounts
...
Hosts could maximize their revenues if they knew the optimal minimum nights. We aim to identify this optimal
...
USD350 per night and above USD50 per night. Finally, we have decided to exclude Hotel Rooms (n=6)
...
It can be seen that private rooms experience a higher occupancy rates than entire home/apt. The majority
...
offer their listings as private room to increase occupancy rates and increase their revenue as a whole.

Around 30% of the Entire Apt listings offered in Austin have more than 1 room, and thus we could use that data points to understand the potential revenue increase that a host could experience if they offered their listings as private room rentals.
...
It can be seen from the graph that entire apartments that have 2 or more bedroom can benefit from listings it as a private room.
