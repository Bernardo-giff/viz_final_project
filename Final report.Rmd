...
However, it is inaccurate to say that the optimal minimum night for luxury is 9. Because there is only one luxury listing at 197,000. 
...
Assumptions for H3
- Listings that have 0 reviews and 0 availability for the
next 365 days will be removed from the data, and we will assume that the
host have blocked these listings.
- Given the Airbnb data, there is no
