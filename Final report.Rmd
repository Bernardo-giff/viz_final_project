...
expected monthly revenue of the airbnb listings. We define the revenue p.a. as:
...
print(p)
```
Based on the plot above, we can conclude that for any city, Airbnb's have a better ROI than regular renting past a certain threshold of nights. Furthermore, we see that that threshold and the overall potential of return for Austin is far superior than those of NYC and SF.
